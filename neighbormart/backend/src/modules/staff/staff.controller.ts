...
export async function getShifts(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    sendSuccess(res, shifts, 'Shifts retrieved successfully');
  } catch (error: unknown) {
...
export async function clockIn(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    sendSuccess(res, attendance, 'Clocked in successfully', 201);
  } catch (error: unknown) {
...
export async function getLeaveRequests(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    sendSuccess(res, requests, 'Leave requests retrieved successfully');
  } catch (error: unknown) {
...
export async function createLeaveRequest(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    if (!staffRecord) {
      sendError(res, 'No staff profile found for this user', 404);
      return;
    }
...
export async function updateLeaveStatus(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    sendSuccess(res, result, `Leave request ${status.toLowerCase()} successfully`);
  } catch (error: unknown) {
